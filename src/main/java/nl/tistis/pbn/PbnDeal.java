...
public class PbnDeal {
  ...
  public PbnHand GetHand(PbnSide oSide) {
    return maHands[oSide.Get()];
  }

  public PbnRanks GetRanks(PbnSide oSide, PbnSuit oSuit) {
    return maHands[oSide.Get()].GetRanks(oSuit);
  }

  public int GetNrRanks(PbnSide oSide, PbnSuit oSuit) {
    return maNrHands[oSide.Get()].GetNrRanks(oSuit);
  }

  public int GetNrRanks(PbnSide oSide) {
    return maNrHands[oSide.Get()].GetNrRanks();
  }

  public void SetRanks(PbnSide oSide, PbnSuit oSuit, PbnRanks oRanks) {
    int iSide = oSide.Get();
  ...
  public boolean PlayCard(PbnSide oSide, PbnCard oCard) {
    boolean bOk;
    int iSide = oSide.Get();
  ...
  public boolean UnplayCard(PbnSide oSide, PbnCard oCard) {
    boolean bOk;
    int iSide = oSide.Get();
