...
public class PbnError {
  ...
  public PbnError(int iError) {
    mError = iError;
  }

  public PbnError(PbnError oPbnError) {
  ...
  public void Set(int iError) {
    mError = iError;
  }

  public void Set(PbnError oError) {
    mError = oError.mError;
  }

  public void SetWorst(PbnError oError) {
  ...
  public boolean HasSeverity(int iSeverity) {
