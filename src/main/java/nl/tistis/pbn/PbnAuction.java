...
public class PbnAuction {
  ...
  public PbnCall GetCall(int iIndex) {
  ...
  public PbnError CheckValidCall(PbnCall oCall) {
     ...
     */
    bOk = (NrPasses < PbnSide.NUMBER - 1) || ((IxCallReal == -1) && (NrPasses < PbnSide.NUMBER));
    ...
    if (bOk) {
      switch (oCall.GetType()) {
        ...
        case PbnCall.TYPE_DBL:
           ...
           */
          bOk = (IxCallReal > IxCallRdbl) && ((mNrCalls & 1) != (IxCallReal & 1));
          break;
        ...
        case PbnCall.TYPE_REAL:
           ...
           */
          bOk = (IxCallReal == -1) || (oCall.IsBigger(maCalls[IxCallReal]));
          break;
        ...
        case PbnCall.TYPE_INSUFF:
           ...
           */
          bOk = (IxCallReal >= 0) && (!oCall.IsBigger(maCalls[IxCallReal]));
          break;
  ...
  public PbnError StoreCall(PbnCall oCall) {
    PbnError lPbnError;
   ...
   *  b. Declarer unknown: "?"
   */
  public PbnError Verify(PbnSide oDealer, PbnContract oContract) {
    ...
    for (int i = 0; i < mNrCalls; i++) {
      ...
      switch (lCall.GetType()) {
        ...
        case PbnCall.TYPE_INSUFF:
          ...
          if (laaSides[lCallSide.Get()][lCall.GetTrump().Get()] == SIDE_HIGH) {
    ...
    if (NrPasses == PbnSide.NUMBER) {
    ...
    } else if ((mNrCalls >= PbnSide.NUMBER) && (NrPasses == PbnSide.NUMBER - 1)) {
      /*
       * Auction complete.
       */
      ...
      if (lTrump.Is(PbnTrump.NONE)) {
        ...
        if (lDeclarer.IsValid()) {
          ...
          if (laaSides[lPartner.Get()][lTrump.Get()] < laaSides[lDeclarer.Get()][lTrump.Get()]) {
            /*
