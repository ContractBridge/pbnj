...
public class PbnCommentAdmin {
  ...
  public PbnCommentAdmin(PbnImportAdmin oImportAdmin, PbnGameTags oGameTags) {
  ...
  private void Put(String oString) {
    mGameTags.PutComment(
            "" + mKind + oString,
  ...
  public void SetType(int iType, int iTagIndex) {
    mType = iType;
    mTagIndex = iTagIndex;
  }

  public void Begin(int iBeginIndex) {
    mKind = PbnComment.BEGIN;
    mBeginIndex = iBeginIndex;
  }

  public void End(String oString, int iEndIndex) {
  ...
  public void Eol(String oString) {
    mKind = PbnComment.EOL;
    oString = oString.substring(mBeginIndex);
    Put(oString);
  }

  public void Next(String oString) {
    oString = oString.substring(mBeginIndex);
    Put(oString);
